    ...
    return [
            ...
            [
                ...
                lp.Block(
                    [
                        ...
                        pl.VSpace(-0.3),
                        pl.UnorderedList([
                            ['We are passing', index_false_mono, 'because usually the 0, 1, 2 ... index is not useful'],
                            ["If you had set your index to something useful, then don't include", index_false_mono]
                        ])
                    ],
                ...
                lp.AlertBlock(
                    [
                        ['When', pd_mono, 'writes to a workbook, it replaces the file. Do not write over an existing '
        ...
        lp.DimRevealListFrame(
            [
                ...
                ['You can', pl.Bold('manipulate Excel from Python,'), 'which gives you the full power of Excel from',
                ...
                ['Or you can', pl.Bold('run Python from Excel'), 'using one of two approaches:',
                 pl.Underline('Python as a VBA replacement'), 'and', pl.Underline('user-defined functions (UDFs)')],
        ...
        lp.TwoColumnGraphicDimRevealFrame(
            [
                [xlwings_mono, 'UDFs allow you to create your own Excel functions, that when executed, run Python code'],
        ...
        lp.DimRevealListFrame(
            [
                ...
                ['Now in the command prompt, run', quickstart_project_mono, 'with whatever project name you want.'],
        ...
        lp.Frame(
            [
                LabBlock(
                    [
                        pl.OrderedList([
                            ['If you have not already created your', xlwings_mono, 'project, go back two slides',
                            ...
                            'to them.',
                            ['Call your', random_choice_mono, 'function on these inputs, and see it pick a random item']
                        ])
                    ],
