...
# TODO: this whole thing is a mess. Tried to make one reusable class for creating this graphic, but was having issues
# TODO: actually getting it to work. It seems the graphics sizes are not working as expected. Therefore I made a
# TODO: separate class for each version of the graphic, with some values hard-coded, and these classes are not
# TODO: reusable at all.
