...
\begin{tikzpicture}
\node [fill=orange!30, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (6e34e008-eede-4cf1-b3ff-8ab87de974c1) at (-3.35, 4) {\textbf{Inputs}};
\coordinate [fill=blue!50, minimum width=5cm, minimum height=8cm, rectangle, draw] (5ddf823c-b475-4b1a-96a7-d844b944a6fd) at (1.25, 4) {};
\node [text=white, above=0.2cm ] (a4484a03-7508-4f28-9024-28567e0deb73) at (5ddf823c-b475-4b1a-96a7-d844b944a6fd.south) {\textbf{Model}};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (ef45c225-787c-42f4-afe2-60af4a088797) at (1.25, 1.75) {};
\node [text=white, above] (3e871387-b67d-4c30-9cfc-f601dbc81335) at (ef45c225-787c-42f4-afe2-60af4a088797.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (500ee3c7-daab-432e-bff4-77cae6a5a24a) at (1.25, 4.25) {};
\node [text=white, above] (93fbb464-f346-4edf-8551-b38b8a675bc2) at (500ee3c7-daab-432e-bff4-77cae6a5a24a.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (d5f32557-4ee5-4f95-a9a9-555d08ffc71a) at (1.25, 6.75) {};
\node [text=white, above] (55a050bc-78c3-4a3b-aee9-8a818cd813b6) at (d5f32557-4ee5-4f95-a9a9-555d08ffc71a.south) {Sub-Model};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (30a9251c-5dc8-4655-871a-0874751a8eeb) at (0.0, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (331b1e0a-48a7-468c-9db5-acccc9ec3338) at (1.25, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (702f6c0c-d5f2-455d-8193-2555a6af4d33) at (2.5, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (e67cfdbb-8fb5-47a0-80af-c9e5da9e3c9f) at (0.0, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (a2aa2914-3c04-4d75-b04c-fa09f4616561) at (1.25, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (2c74d90c-734d-44e4-9d00-19f75a90d492) at (2.5, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (3eb6693b-1b4f-4188-840f-f0c4d3ae2e86) at (0.0, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (b746f354-ec7b-4d6c-ac46-ec41105a1474) at (1.25, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (e0be737a-9f4f-4528-869f-473bd1189a53) at (2.5, 6.95) {Step};
\node [fill=green!20, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (733f081e-52f1-4e08-8ff9-bf7e5714882b) at (5.85, 4) {\textbf{Outputs}};
