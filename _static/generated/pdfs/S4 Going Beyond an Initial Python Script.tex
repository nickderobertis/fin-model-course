...
\begin{tikzpicture}
\node [fill=orange!30, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (3db2a7b3-71aa-489b-ad78-07da0d5ed8a6) at (-3.35, 4) {\textbf{Inputs}};
\coordinate [fill=blue!50, minimum width=5cm, minimum height=8cm, rectangle, draw] (d5e425be-f0c2-42ee-9885-9a1350031a88) at (1.25, 4) {};
\node [text=white, above=0.2cm ] (fa6ec3f9-bbc8-439a-9c3a-6c275424fd76) at (d5e425be-f0c2-42ee-9885-9a1350031a88.south) {\textbf{Model}};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (df1d80c0-f5c0-4622-8b80-bf40cce7cda5) at (1.25, 1.75) {};
\node [text=white, above] (76285e5a-6880-4ae0-b393-1facefd4145e) at (df1d80c0-f5c0-4622-8b80-bf40cce7cda5.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (0374ebc8-df16-4d02-a526-517b33257648) at (1.25, 4.25) {};
\node [text=white, above] (6e1a4f3e-157d-4d2f-8b04-2d5bfa1ea5a4) at (0374ebc8-df16-4d02-a526-517b33257648.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (b3aef407-bb75-4a71-9f8d-f1d126a1a572) at (1.25, 6.75) {};
\node [text=white, above] (2bfcf238-cef9-4cff-90d8-c103a236f7d0) at (b3aef407-bb75-4a71-9f8d-f1d126a1a572.south) {Sub-Model};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (2cf7bdf5-5576-44ab-9141-5d86f6482718) at (0.0, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (ff9d2915-75a0-4f40-8ffa-a9c6ff3c4c92) at (1.25, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (f8185b65-7df6-447e-bc48-586f17b15a57) at (2.5, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (8bdc3cc4-6a1f-425d-8ef3-e5dfa8e4c535) at (0.0, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (570e2cd5-3c09-44ed-9e36-850733678c75) at (1.25, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (e98a779c-5869-46e4-801c-7bc10e26b2a6) at (2.5, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (abca9048-c6c2-4fff-8ab0-7e7fa270ab9a) at (0.0, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (6449fd3d-4842-45cc-9ecf-30247668ba03) at (1.25, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (47c6a7fe-bb56-4128-a59c-56f9b76bf1e4) at (2.5, 6.95) {Step};
\node [fill=green!20, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (4abb4d25-fc87-4beb-b373-327929ce2272) at (5.85, 4) {\textbf{Outputs}};
