...
\begin{tikzpicture}
\node [fill=orange!30, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (f7b4ae13-1667-49cc-848a-36755f62c78d) at (-3.35, 4) {\textbf{Inputs}};
\coordinate [fill=blue!50, minimum width=5cm, minimum height=8cm, rectangle, draw] (aa856976-b200-4da0-b2d2-e6487249303e) at (1.25, 4) {};
\node [text=white, above=0.2cm ] (ddddc010-b694-4da5-9108-0fdc43e0c221) at (aa856976-b200-4da0-b2d2-e6487249303e.south) {\textbf{Model}};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (4f3d13a3-7ea2-4fa0-9c3f-20a2e00d3533) at (1.25, 1.75) {};
\node [text=white, above] (6c746af3-0b50-4846-b830-591f8a236fe3) at (4f3d13a3-7ea2-4fa0-9c3f-20a2e00d3533.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (a45ef15e-a3c3-4892-b05f-553b0ac2c6f7) at (1.25, 4.25) {};
\node [text=white, above] (8dd06fee-8fbf-4476-8680-fc995890b9b9) at (a45ef15e-a3c3-4892-b05f-553b0ac2c6f7.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (6e398f38-9b47-4b5b-84c7-97349e60ff14) at (1.25, 6.75) {};
\node [text=white, above] (b55ccea0-c9bc-4e25-bcb5-93525e9884cb) at (6e398f38-9b47-4b5b-84c7-97349e60ff14.south) {Sub-Model};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (8100fde2-7de8-4427-9a5d-a2e81d677531) at (0.0, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (a82cae41-1702-4155-bcbd-075a7c0ee9d8) at (1.25, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (28aa626a-382f-448a-b7e4-abfa211eb7af) at (2.5, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (e7096022-e70c-4f21-9080-26e108935a61) at (0.0, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (5b36a7b8-913f-45e6-a1fa-a059fc2b7a84) at (1.25, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (0e562e2a-384a-4b2e-87d8-feb9c4c8d03a) at (2.5, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (f631c29f-86a7-43e1-8f96-2cd2e492e799) at (0.0, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (da50694f-d7ba-431b-bcc0-e69cc9b918a2) at (1.25, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (56d53192-57c9-4ac4-be2d-7b83935531eb) at (2.5, 6.95) {Step};
\node [fill=green!20, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (0708c0fd-3b75-4aa6-8038-f97f4beff7b7) at (5.85, 4) {\textbf{Outputs}};
