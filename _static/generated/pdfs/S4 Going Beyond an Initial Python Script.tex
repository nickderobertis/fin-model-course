...
\begin{tikzpicture}
\node [fill=orange!30, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (133a4ad1-cb06-49dc-9e20-34fbe122a1bf) at (-3.35, 4) {\textbf{Inputs}};
\coordinate [fill=blue!50, minimum width=5cm, minimum height=8cm, rectangle, draw] (80db54e7-5856-4ac2-83b1-7aaf33e6df66) at (1.25, 4) {};
\node [text=white, above=0.2cm ] (c112de39-eed3-4d4d-a44c-c4ed6acd5201) at (80db54e7-5856-4ac2-83b1-7aaf33e6df66.south) {\textbf{Model}};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (fc4cf0e5-0c0b-4c33-b31a-5733e1241913) at (1.25, 1.75) {};
\node [text=white, above] (228c44fd-358e-471a-ba35-a10d2827c4bf) at (fc4cf0e5-0c0b-4c33-b31a-5733e1241913.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (e3ecad63-11ff-437b-bf47-b7a337066c1a) at (1.25, 4.25) {};
\node [text=white, above] (dde1cb4a-3654-423a-9639-0239efc395c9) at (e3ecad63-11ff-437b-bf47-b7a337066c1a.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (d32173a0-67ec-4b7a-b943-d3db42881358) at (1.25, 6.75) {};
\node [text=white, above] (bc8ace85-db17-412c-a5be-7af770b381b0) at (d32173a0-67ec-4b7a-b943-d3db42881358.south) {Sub-Model};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (ec5d97db-2b15-4d47-b739-37459c049e05) at (0.0, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (3cc024c3-c59c-4785-b03b-7a2ac843d684) at (1.25, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (68b4c6ee-00a7-40d9-88fe-fb75febf9b0f) at (2.5, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (bd9a2309-8b7f-4c79-a6df-f8a69e27b9b5) at (0.0, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (b160c36c-329a-4adb-bc57-1b415066e852) at (1.25, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (f0c47c6f-9d36-4e24-8abc-a56c481fc342) at (2.5, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (b48ab027-b4d4-4131-8d20-c66c6c02d54f) at (0.0, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (f7b4ae13-1667-49cc-848a-36755f62c78d) at (1.25, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (aa856976-b200-4da0-b2d2-e6487249303e) at (2.5, 6.95) {Step};
\node [fill=green!20, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (8fe197b4-2a19-4c68-b29d-77606584eb06) at (5.85, 4) {\textbf{Outputs}};
