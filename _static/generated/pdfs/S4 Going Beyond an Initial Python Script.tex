...
\begin{itemize}
\item On Canvas, there is a Jupyter notebook containing all of the examples for today's lecture
\item It's at Examples > Intro > Python > Python Basics.ipynb
...
\begin{enumerate}
\item On Canvas, there is a Jupyter notebook containing all of the labs for today's lecture
\item It's at Labs > Intro > Python > Python Basics Lab.ipynb
...
\vfill
\item For example, we can create two different lists. They will have different contents, but we cando
\texttt{.append}
