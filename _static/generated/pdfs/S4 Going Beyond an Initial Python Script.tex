...
\begin{tikzpicture}
\node [fill=orange!30, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (dde1cb4a-3654-423a-9639-0239efc395c9) at (-3.35, 4) {\textbf{Inputs}};
\coordinate [fill=blue!50, minimum width=5cm, minimum height=8cm, rectangle, draw] (bd9a2309-8b7f-4c79-a6df-f8a69e27b9b5) at (1.25, 4) {};
\node [text=white, above=0.2cm ] (b160c36c-329a-4adb-bc57-1b415066e852) at (bd9a2309-8b7f-4c79-a6df-f8a69e27b9b5.south) {\textbf{Model}};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (d32173a0-67ec-4b7a-b943-d3db42881358) at (1.25, 1.75) {};
\node [text=white, above] (bc8ace85-db17-412c-a5be-7af770b381b0) at (d32173a0-67ec-4b7a-b943-d3db42881358.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (ddddc010-b694-4da5-9108-0fdc43e0c221) at (1.25, 4.25) {};
\node [text=white, above] (0708c0fd-3b75-4aa6-8038-f97f4beff7b7) at (ddddc010-b694-4da5-9108-0fdc43e0c221.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (a82cae41-1702-4155-bcbd-075a7c0ee9d8) at (1.25, 6.75) {};
\node [text=white, above] (28aa626a-382f-448a-b7e4-abfa211eb7af) at (a82cae41-1702-4155-bcbd-075a7c0ee9d8.south) {Sub-Model};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (b48ab027-b4d4-4131-8d20-c66c6c02d54f) at (0.0, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (f7b4ae13-1667-49cc-848a-36755f62c78d) at (1.25, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (aa856976-b200-4da0-b2d2-e6487249303e) at (2.5, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (4f3d13a3-7ea2-4fa0-9c3f-20a2e00d3533) at (0.0, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (6c746af3-0b50-4846-b830-591f8a236fe3) at (1.25, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (8100fde2-7de8-4427-9a5d-a2e81d677531) at (2.5, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (a45ef15e-a3c3-4892-b05f-553b0ac2c6f7) at (0.0, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (8dd06fee-8fbf-4476-8680-fc995890b9b9) at (1.25, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (e7096022-e70c-4f21-9080-26e108935a61) at (2.5, 6.95) {Step};
\node [fill=green!20, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (f0c47c6f-9d36-4e24-8abc-a56c481fc342) at (5.85, 4) {\textbf{Outputs}};
