...
\begin{tikzpicture}
\node [fill=orange!30, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (ab3d5dad-7dfb-43ae-aa5d-3acc752e0aad) at (-3.35, 4) {\textbf{Inputs}};
\coordinate [fill=blue!50, minimum width=5cm, minimum height=8cm, rectangle, draw] (f9bf7c24-76fd-46b5-aab1-e33305c3d589) at (1.25, 4) {};
\node [text=white, above=0.2cm ] (77b7cfc5-f237-4b8b-ade6-b2b41b402949) at (f9bf7c24-76fd-46b5-aab1-e33305c3d589.south) {\textbf{Model}};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (4a6151fc-a83a-4b5b-9e7c-e5ffde1e4b60) at (1.25, 1.75) {};
\node [text=white, above] (755d7c98-4778-44f2-bbf4-030d2473a6b6) at (4a6151fc-a83a-4b5b-9e7c-e5ffde1e4b60.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (8fe197b4-2a19-4c68-b29d-77606584eb06) at (1.25, 4.25) {};
\node [text=white, above] (fc4cf0e5-0c0b-4c33-b31a-5733e1241913) at (8fe197b4-2a19-4c68-b29d-77606584eb06.south) {Sub-Model};
\coordinate [fill=blue!90, minimum width=4cm, minimum height=1.75cm, rectangle, draw] (68b4c6ee-00a7-40d9-88fe-fb75febf9b0f) at (1.25, 6.75) {};
\node [text=white, above] (e3ecad63-11ff-437b-bf47-b7a337066c1a) at (68b4c6ee-00a7-40d9-88fe-fb75febf9b0f.south) {Sub-Model};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (133a4ad1-cb06-49dc-9e20-34fbe122a1bf) at (0.0, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (80db54e7-5856-4ac2-83b1-7aaf33e6df66) at (1.25, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (c112de39-eed3-4d4d-a44c-c4ed6acd5201) at (2.5, 1.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (228c44fd-358e-471a-ba35-a10d2827c4bf) at (0.0, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (ec5d97db-2b15-4d47-b739-37459c049e05) at (1.25, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (3cc024c3-c59c-4785-b03b-7a2ac843d684) at (2.5, 4.45) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (dde1cb4a-3654-423a-9639-0239efc395c9) at (0.0, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (bd9a2309-8b7f-4c79-a6df-f8a69e27b9b5) at (1.25, 6.95) {Step};
\node [fill=cyan!20, minimum width=1.1cm, minimum height=1cm, rectangle, draw, text=black] (b160c36c-329a-4adb-bc57-1b415066e852) at (2.5, 6.95) {Step};
\node [fill=green!20, minimum width=2cm, minimum height=8cm, rectangle, draw, text=black] (170050d0-04a2-4a41-8a84-c7c58c1e31e8) at (5.85, 4) {\textbf{Outputs}};
