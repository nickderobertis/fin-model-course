...
\end{frame}
\begin{frame}
\frametitle{Monte Carlo Simulation of DDM, Level 1}
{
\setbeamercolor{block title}{bg=violet}
\begin{block}{Intro Monte Carlo, Level 1}
\begin{enumerate}
\footnotesize
...
\toprule
\hfill & Level 2: Slide \textcolor{blue}{\underline{\ref{lab:intro-monte-carlo-python-2}}} & \hfill\\

\end{tabular*}
\end{block}
}
\label{lab:intro-monte-carlo-python-1}
\end{frame}
\end{section}
...
\end{frame}
\begin{frame}
\frametitle{Monte Carlo Simulation of Python Models, Level 1}
{
\setbeamercolor{block title}{bg=violet}
\begin{block}{Monte Carlo Python, Level 1}
\begin{enumerate}
\small
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}ccc}
\toprule
\hfill & Level 2: Slide \textcolor{blue}{\underline{\ref{lab:monte-carlo-python-2}}} & \hfill\\

\end{tabular*}
\end{block}
}
\label{lab:monte-carlo-python-1}
\end{frame}
\end{section}
...
\end{frame}
\begin{frame}
\frametitle{Monte Carlo Simulation of Excel Models, Level 1}
{
\setbeamercolor{block title}{bg=violet}
\begin{block}{Monte Carlo Excel, Level 1}
\begin{enumerate}
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}ccc}
\toprule
\hfill & Level 2: Slide \textcolor{blue}{\underline{\ref{lab:monte-carlo-excel-2}}} & \hfill\\

\end{tabular*}
\end{block}
}
\label{lab:monte-carlo-excel-1}
\end{frame}
\end{section}
\appendix
...
\begin{frame}
\frametitle{Monte Carlo Simulation of DDM, Level 2}
{
\setbeamercolor{block title}{bg=violet}
\begin{block}{Intro Monte Carlo, Level 2}
\begin{enumerate}
\small
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}ccc}
\toprule
\hfill & Level 1: Slide \textcolor{blue}{\underline{\ref{lab:intro-monte-carlo-python-1}}} & \hfill\\

\end{tabular*}
\end{block}
}
\label{lab:intro-monte-carlo-python-2}
\end{frame}
\begin{frame}
\frametitle{Monte Carlo Simulation of Python Models, Level 2}
{
\setbeamercolor{block title}{bg=violet}
\begin{block}{Monte Carlo Python, Level 2}
\begin{enumerate}
\small
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}ccc}
\toprule
\hfill & Level 1: Slide \textcolor{blue}{\underline{\ref{lab:monte-carlo-python-1}}} & \hfill\\

\end{tabular*}
\end{block}
}
\label{lab:monte-carlo-python-2}
\end{frame}
\begin{frame}
\frametitle{Monte Carlo Simulation of Excel Models, Level 2}
{
\setbeamercolor{block title}{bg=violet}
\begin{block}{Monte Carlo Excel, Level 2}
\begin{enumerate}
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}ccc}
\toprule
\hfill & Level 1: Slide \textcolor{blue}{\underline{\ref{lab:monte-carlo-excel-1}}} & \hfill\\

\end{tabular*}
\end{block}
}
\label{lab:monte-carlo-excel-2}
\end{frame}
