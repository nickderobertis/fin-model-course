...
\vfill
\item \includegraphics[width=0.5\textwidth]{Sources/excel-if.png}
\vfill
...
\begin{itemize}
\item \includegraphics[width=0.3\textwidth]{Sources/excel-mod.png}
\vfill
...
\begin{itemize}
\item \includegraphics[width=0.5\textwidth]{Sources/excel-vlookup.png}
\vfill
\item Use VLOOKUP when you need to find things in a table or by row
\vfill
\item \includegraphics[width=0.2\textwidth]{Sources/excel-vlookup-example-table.png}
\vfill
